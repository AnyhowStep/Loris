...
echo "testpass" | php ./tools/resetpassword.php admin
...
find ./project/instruments/NDB_BVL_Instrument_testtest.class.inc | php ./tools/lorisform_parser.php
find ./project/instruments/NDB_BVL_Instrument_testtest.class.inc | php ./tools/generate_tables_sql.php
